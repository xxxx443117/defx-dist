...
function(e, t, n) {
	...
	function(n, o) {
		...
		function f() { (se.addEventListener || "load" === n.event.type || "complete" === se.readyState) && (c(), ye.ready())
		}
		function d(e, t, n) {
		...
		function h(e, t, n, r) {
			if (Me(e)) {
				...
				u = s ? ye.cache: e,
				l = s ? e[a] : e[a] && a;
				if (l && u[l] && (r || u[l].data) || void 0 !== n || "string" != typeof t) return l || (l = s ? e[a] = ae.pop() || ye.guid++:a),
				u[l] || (u[l] = s ? {}: {
					toJSON: ye.noop
				}),
				"object" != typeof t && "function" != typeof t || (r ? u[l] = ye.extend(u[l], t) : u[l].data = ye.extend(u[l].data, t)),
				o = u[l],
				r || (o.data || (o.data = {}), o = o.data),
				void 0 !== n && (o[ye.camelCase(t)] = n),
				"string" == typeof t ? (i = o[t], null == i && (i = o[ye.camelCase(t)])) : i = o,
				i
			}
		}
		function g(e, t, n) {
		...
		function w(e, t, n, r, i) {
			...
			p = y(t), h = [], g = 0; g < d; g++) if (a = e[g], a || 0 === a) if ("object" === ye.type(a)) ye.merge(h, a.nodeType ? [a] : a);
			else if (Ge.test(a)) {
			...
			for (u && p.removeChild(u), ge.appendChecked || ye.grep(v(h, "input"), b), g = 0; a = h[g++];) if (r && ye.inArray(a, r) > -1) i && i.push(a);
			else if (s = ye.contains(a.ownerDocument, a), u = v(p.appendChild(a), "script"), s && x(u), n) for (o = 0; a = u[o++];) Ue.test(a.type || "") && n.push(a);
			return u = null,
			p
		}
		function T() {
		...
		function L(e, t, n, r) {
			...
			if (f && (l = w(t, e[0].ownerDocument, !1, e, r), i = l.firstChild, 1 === l.childNodes.length && (l = i), i || r)) {
				for (s = ye.map(v(l, "script"), S), a = s.length; c < f; c++) o = l,
				c !== d && (o = ye.clone(o, !0, !0), a && ye.merge(s, v(o, "script"))),
				n.call(e[c], o, c);
				if (a) for (u = s[s.length - 1].ownerDocument, ye.map(s, A), c = 0; c < a; c++) o = s[c],
				Ue.test(o.type || "") && !ye._data(o, "globalEval") && ye.contains(u, o) && (o.src ? ye._evalUrl && ye._evalUrl(o.src) : ye.globalEval((o.text || o.textContent || o.innerHTML || "").replace(lt, "")));
				l = i = null
			}
			return e
		}
		function H(e, t, n) {
			for (var r, i = t ? ye.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || ye.cleanData(v(r)),
			r.parentNode && (n && ye.contains(r.ownerDocument, r) && x(v(r, "script")), r.parentNode.removeChild(r));
			return e
		}
		function q(e, t) {
		...
		function _(e) {
			var t = se,
			n = pt[e];
			return n || (n = q(e, t), "none" !== n && n || (dt = (dt || ye("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (dt[0].contentWindow || dt[0].contentDocument).document, t.write(), t.close(), n = q(e, t), dt.detach()), pt[e] = n),
			n
		}
		function F(e, t) {
			return {
		...
		function O(e, t) {
			...
			r.style && (o[a] = ye._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Ie(r) && (o[a] = ye._data(r, "olddisplay", _(r.nodeName)))) : (i = Ie(r), (n && "none" !== n || !i) && ye._data(r, "olddisplay", i ? n: ye.css(r, "display"))));
			for (a = 0; a < s; a++) r = e[a],
		...
		function P(e, t, n, r, i) {
			for (var o = n === (r ? "border": "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2)"margin" === n && (a += ye.css(e, n + We[o], !0, i)),
			r ? ("content" === n && (a -= ye.css(e, "padding" + We[o], !0, i)), "margin" !== n && (a -= ye.css(e, "border" + We[o] + "Width", !0, i))) : (a += ye.css(e, "padding" + We[o], !0, i), "padding" !== n && (a += ye.css(e, "border" + We[o] + "Width", !0, i)));
			return a
		}
		function B(e, t, n) {
			var r = !0,
		...
		function X(e, t, n) {
			...
			1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], l = ye.css(e, "display"), c = "none" === l ? ye._data(e, "olddisplay") || _(e.nodeName) : l, "inline" === c && "none" === ye.css(e, "float") && (ge.inlineBlockNeedsLayout && "inline" !== _(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
			n.overflow && (p.overflow = "hidden", ge.shrinkWrapBlocks() || f.always(function() {
		...
		function V(e, t, n) {
			...
			c = l.props;
			for (U(c, l.opts.specialEasing); o < a; o++) if (r = V.prefilters[o].call(l, e, c, l.opts)) return ye.isFunction(r.stop) && (ye._queueHooks(l.elem, l.opts.queue).stop = ye.proxy(r.stop, r)),
			r;
			return ye.map(c, z, l),
		...
		ye.extend = ye.fn.extend = function() {
			...
			s++), "object" == typeof a || ye.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++) if (null != (i = arguments[s])) for (r in i) e = a[r],
			n = i[r],
			a !== n && (l && n && (ye.isPlainObject(n) || (t = ye.isArray(n))) ? (t ? (t = !1, o = e && ye.isArray(e) ? e: []) : o = e && ye.isPlainObject(e) ? e: {},
		...
		ye.extend({
			...
			proxy: function(e, t) {
				var n, r, i;
				if ("string" == typeof t && (i = e[t], t = e, e = i), ye.isFunction(e)) return n = ue.call(arguments, 2),
				r = function() {
	 ...
	 */
		...
		ye.fn.extend({
			find: function(e) {
				...
				return n = this.pushStack(i > 1 ? ye.unique(n) : n),
		...
		ye.fn.extend({
			...
			closest: function(e, t) {
				for (var n, r = 0,
				i = this.length,
				o = [], a = Ne.test(e) || "string" != typeof e ? ye(e, t || this.context) : 0; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && ye.find.matchesSelector(n, e))) {
					o.push(n);
					break
				}
		...
		function(e, t) {
			ye.fn[e] = function(n, r) {
				...
				this.length > 1 && (He[e] || (i = ye.uniqueSort(i)), Le.test(e) && (i = i.reverse())),
				this.pushStack(i)
			}
		});
		var qe = /\S+/g;
		...
		ye.extend({
			...
			ready: function(e) { (e === !0 ? --ye.readyWait: ye.isReady) || (ye.isReady = !0, e !== !0 && --ye.readyWait > 0 || (_e.resolveWith(se, [ye]), ye.fn.triggerHandler && (ye(se).triggerHandler("ready"), ye(se).off("ready"))))
			}
		}),
		ye.ready.promise = function(e) {
			if (!_e) if (_e = ye.Deferred(), "complete" === se.readyState || "loading" !== se.readyState && !se.documentElement.doScroll) n.setTimeout(ye.ready);
		...
		ye.fn.extend({
			...
			promise: function(e, t) {
				...
				for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--;) n = ye._data(o[a], e + "queueHooks"),
		...
		function() {
			...
			(ge[e] = t in n) || (r.setAttribute(t, "t"), ge[e] = r.attributes[t].expando === !1);
			r = null
		} ();
		...
		ye.event = {
			...
			add: function(e, t, n, r, i) {
				...
				if (m) {
					...
					c.elem = e), t = (t || "").match(qe) || [""], s = t.length; s--;) o = nt.exec(t[s]) || [],
					p = g = o[1],
					h = (o[2] || "").split(".").sort(),
					p && (l = ye.event.special[p] || {},
					p = (i ? l.delegateType: l.bindType) || p, l = ye.event.special[p] || {},
					f = ye.extend({
						type: p,
						origType: g,
						data: r,
			...
			trigger: function(e, t, r, i) {
				...
				if (s = c = r = r || se, 3 !== r.nodeType && 8 !== r.nodeType && !tt.test(p + ye.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, e = e[ye.expando] ? e: new ye.Event(p, "object" == typeof e && e), e.isTrigger = i ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : ye.makeArray(t, [e]), l = ye.event.special[p] || {},
				i || !l.trigger || l.trigger.apply(r, t) !== !1)) {
					if (!i && !l.noBubble && !ye.isWindow(r)) {
						for (u = l.delegateType || p, tt.test(u + p) || (s = s.parentNode); s; s = s.parentNode) d.push(s),
						c = s;
						c === (r.ownerDocument || se) && d.push(c.defaultView || c.parentWindow || n)
					}
					for (f = 0; (s = d[f++]) && !e.isPropagationStopped();) e.type = f > 1 ? u: l.bindType || p,
			...
			handlers: function(e, t) {
				...
				if (s && u.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1)) for (; u != this; u = u.parentNode || this) if (1 === u.nodeType && (u.disabled !== !0 || "click" !== e.type)) {
					...
					i = o.selector + " ",
					void 0 === r[i] && (r[i] = o.needsContext ? ye(i, this).index(u) > -1 : ye.find(i, this, null, [u]).length),
					r[i] && r.push(o);
					r.length && a.push({
						elem: u,
						handlers: r
			...
			fix: function(e) {
				...
				o = e,
				a = this.fixHooks[i];
				for (a || (this.fixHooks[i] = a = et.test(i) ? this.mouseHooks: Ze.test(i) ? this.keyHooks: {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ye.Event(o), t = r.length; t--;) n = r[t],
				e[n] = o[n];
			...
			special: {
				...
				click: {
					trigger: function() {
						if (ye.nodeName(this, "input") && "checkbox" === this.type && this.click) return this.click(),
						!1
					},
					_default: function(e) {
		...
		ye.removeEvent = se.removeEventListener ?
		function(e, t, n) {
		...
		ge.change || (ye.event.special.change = {
			setup: function() {
				return Ke.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (ye.event.add(this, "propertychange._change",
				function(e) {
				...
				function(e) {
					var t = e.target;
					Ke.test(t.nodeName) && !ye._data(t, "change") && (ye.event.add(t, "change._change",
		...
		ye.extend({
			...
			clone: function(e, t, n) {
				...
				if (t) if (n) for (s = s || v(e), r = r || v(o), a = 0; null != (i = s[a]); a++) D(i, r[a]);
				else D(e, o);
				return r = v(o, "script"),
				r.length > 0 && x(r, !u && v(e, "script")),
				r = s = i = null,
				o
			},
			cleanData: function(e, t) {
				...
				u = ye.cache,
				l = ge.attributes,
				c = ye.event.special; null != (n = e[a]); a++) if ((t || Me(n)) && (i = n[s], o = i && u[i])) {
			...
			html: function(e) {
				...
				function(e) {
					...
					if ("string" == typeof e && !at.test(e) && (ge.htmlSerialize || !it.test(e)) && (ge.leadingWhitespace || !Ve.test(e)) && !Ye[(Xe.exec(e) || ["", ""])[1].toLowerCase()]) {
						...
						try {
							for (; n < r; n++) t = this[n] || {},
							1 === t.nodeType && (ye.cleanData(v(t, !1)), t.innerHTML = e);
							t = 0
						} catch(i) {}
					}
		...
		function(e, t) {
			ye.fn[e] = function(e) {
				for (var n, r = 0,
				i = [], o = ye(e), a = o.length - 1; r <= a; r++) n = r === a ? this: this.clone(!0),
				ye(o[r])[t](n),
				ce.apply(i, n.get());
		...
		function() {
			function e() {
				...
				t = i = s = !1,
				r = a = !0,
				n.getComputedStyle && (c = n.getComputedStyle(l), t = "1%" !== (c || {}).top, s = "2px" === (c || {}).marginLeft, i = "4px" === (c || {
					width: "4px"
				}).width, l.style.marginRight = "50%", r = "4px" === (c || {
					marginRight: "4px"
				}).marginRight, e = l.appendChild(se.createElement("div")), e.style.cssText = l.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", e.style.marginRight = e.style.width = "0", l.style.width = "1px", a = !parseFloat((n.getComputedStyle(e) || {}).marginRight), l.removeChild(e)),
				l.style.display = "none",
				o = 0 === l.getClientRects().length,
				o && (l.style.display = "", l.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", l.childNodes[0].style.borderCollapse = "separate", e = l.getElementsByTagName("td"), e[0].style.cssText = "margin:0;border:0;padding:0;display:none", o = 0 === e[0].offsetHeight, o && (e[0].style.display = "", e[1].style.display = "none", o = 0 === e[0].offsetHeight)),
				f.removeChild(u)
			}
		...
		xt = function(e, t, n) {
			...
			n && !ge.pixelMarginRight() && gt.test(a) && ht.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o),
			void 0 === a ? a: a + ""
		...
		xt = function(e, t, n) {
			...
			a = n ? n[t] : void 0,
			null == a && s && s[t] && (a = s[t]),
			gt.test(a) && !bt.test(t) && (r = s.left, i = e.runtimeStyle, o = i && i.left, o && (i.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em": a, a = s.pixelLeft + "px", s.left = r, o && (i.left = o)),
			void 0 === a ? a: a + "" || "auto"
		});
		var wt = /alpha\([^)]*\)/i,
		Tt = /opacity\s*=\s*([^)]*)/i,
		...
		function(e, t) {
			ye.cssHooks[t] = {
				get: function(e, n, r) {
					if (n) return Ct.test(ye.css(e, "display")) && 0 === e.offsetWidth ? mt(e, Nt,
					function() {
						return B(e, t, r)
					}) : B(e, t, r)
				},
		...
		ge.opacity || (ye.cssHooks.opacity = {
			...
			set: function(e, t) {
				...
				n.zoom = 1,
				(t >= 1 || "" === t) && "" === ye.trim(o.replace(wt, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter) || (n.filter = wt.test(o) ? o.replace(wt, i) : o + " " + i)
			}
		}),
		ye.cssHooks.marginRight = F(ge.reliableMarginRight,
		function(e, t) {
			if (t) return mt(e, {
		...
		ye.cssHooks.marginLeft = F(ge.reliableMarginLeft,
		function(e, t) {
		...
		function(e, t) {
			ye.cssHooks[e + t] = {
				expand: function(n) {
					for (var r = 0,
					i = {},
					o = "string" == typeof n ? n.split(" ") : [n]; r < 4; r++) i[e + We[r] + t] = o[r] || o[r - 2] || o[0];
					return i
				}
			},
		...
		ye.fn.extend({
			...
			animate: function(e, t, n, r) {
				...
				a = function() {
					...
					e), o); (i || ye._data(this, "finish")) && t.stop(!0)
				};
				return a.finish = a,
		...
		ye.fx.tick = function() {
			var e, t = ye.timers,
			n = 0;
			for (Dt = ye.now(); n < t.length; n++) e = t[n],
		...
		ye.fn.extend({
			val: function(e) {
				var t, n, r, i = this[0]; {
					if (arguments.length) return r = ye.isFunction(e),
					this.each(function(n) {
						var i;
						1 === this.nodeType && (i = r ? e.call(this, n, ye(this).val()) : e, null == i ? i = "": "number" == typeof i ? i += "": ye.isArray(i) && (i = ye.map(i,
						function(e) {
							return null == e ? "": e + ""
						})), t = ye.valHooks[this.type] || ye.valHooks[this.nodeName.toLowerCase()], t && "set" in t && void 0 !== t.set(this, i, "value") || (this.value = i))
					});
					if (i) return t = ye.valHooks[i.type] || ye.valHooks[i.nodeName.toLowerCase()],
					t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n: (n = i.value, "string" == typeof n ? n.replace(qt, "") : null == n ? "": n)
				}
			}
		}),
		ye.extend({
			valHooks: {
				...
				select: {
					get: function(e) {
						...
						a = o ? null: [], s = o ? i + 1 : r.length, u = i < 0 ? s: o ? i: 0; u < s; u++) if (n = r[u], (n.selected || u === i) && (ge.optDisabled ? !n.disabled: null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !ye.nodeName(n.parentNode, "optgroup"))) {
					...
					set: function(e, t) {
						...
						o = ye.makeArray(t), a = i.length; a--;) if (r = i[a], ye.inArray(ye.valHooks.option.get(r), o) > -1) try {
							r.selected = n = !0
						} catch(s) {
							r.scrollHeight
						} else r.selected = !1;
		...
		ye.extend({
			...
			removeAttr: function(e, t) {
				var n, r, i = 0,
				o = t && t.match(qe);
				if (o && 1 === e.nodeType) for (; n = o[i++];) r = ye.propFix[n] || n,
				ye.expr.match.bool.test(n) ? Bt && Pt || !Rt.test(n) ? e[r] = !1 : e[ye.camelCase("default-" + n)] = e[r] = !1 : ye.attr(e, n, ""),
				e.removeAttribute(Pt ? n: r)
			}
		}),
		Mt = {
			set: function(e, t, n) {
				return t === !1 ? ye.removeAttr(e, n) : Bt && Pt || !Rt.test(n) ? e.setAttribute(!Pt && ye.propFix[n] || n, n) : e[ye.camelCase("default-" + n)] = e[n] = !0,
				n
			}
		},
		...
		ge.hrefNormalized || ye.each(["href", "src"],
		function(e, t) {
			ye.propHooks[t] = {
				get: function(e) {
		...
		ye.fn.extend({
			...
			toggleClass: function(e, t) {
				...
				return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : ye.isFunction(e) ? this.each(function(n) {
					...
					var t, r, i, o;
					if ("string" === n) for (r = 0, i = ye(this), o = e.match(qe) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
		...
		ye.extend({
			...
			ajax: function(e, t) {
				...
				t = t || {};
				var i, o, a, s, u, l, c, f, d = ye.ajaxSetup({},
				t),
				p = d.context || d,
				...
				a = d.url,
				d.hasContent || (d.data && (a = d.url += (Ut.test(a) ? "&": "?") + d.data, delete d.data), d.cache === !1 && (d.url = Yt.test(a) ? a.replace(Yt, "$1_=" + Xt++) : a + (Ut.test(a) ? "&": "?") + "_=" + Xt++)),
			...
			if (!e.crossDomain || ge.cors) {
				...
				return {
					send: function(r, i) {
						...
						t = function(n, r) {
							var o, u, l;
							if (t && (r || 4 === a.readyState)) if (delete pn[s], t = void 0, a.onreadystatechange = ye.noop, r) 4 !== a.readyState && a.abort();
							else {
								l = {},
								o = a.status,
		...
		function(e, t, r) {
			...
			s ? e[s] = e[s].replace(mn, "$1" + i) : e.jsonp !== !1 && (e.url += (Ut.test(e.url) ? "&": "?") + e.jsonp + "=" + i),
		...
		ye.offset = {
			setOffset: function(e, t, n) {
				...
				o = ye.css(e, "top"),
				u = ye.css(e, "left"),
				l = ("absolute" === c || "fixed" === c) && ye.inArray("auto", [o, u]) > -1,
		...
		ye.fn.extend({
			offset: function(e) {
				...
				ye.contains(t, i) ? ("undefined" != typeof i.getBoundingClientRect && (r = i.getBoundingClientRect()), n = oe(o), {
		...
		ye.each(["top", "left"],
		function(e, t) {
			ye.cssHooks[t] = F(ge.pixelPosition,
			function(e, n) {
